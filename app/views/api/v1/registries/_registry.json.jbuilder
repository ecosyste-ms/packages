json.extract! registry, :name, :url, :ecosystem, :default, :packages_count, :versions_count, :maintainers_count, :namespaces_count, :keywords_count, :downloads, :github, :metadata, :icon_url, :created_at, :updated_at
