json.extract! package, :name, :ecosystem, :description, :homepage, :licenses, :repository_url, :keywords_array, :namespace, :versions_count, :first_release_published_at, :latest_release_published_at, :latest_release_number, :last_synced_at, :created_at, :updated_at, :registry_url, :install_command, :documentation_url, :metadata, :repo_metadata, :repo_metadata_updated_at, :dependent_packages_count, :downloads, :downloads_period, :dependent_repos_count, :rankings, :purl, :advisories
