...
class CpanTest < ActiveSupport::TestCase
  ...
  test 'dependencies_metadata' do
    ...
    assert_equal dependencies_metadata, [
      {:package_name=>"Test-More", :requirements=>"0", :kind=>"test", :platform=>"Cpan"},
      {:package_name=>"TAP-Harness", :requirements=>"0", :kind=>"test", :platform=>"Cpan"},
      {:package_name=>"Module-Build", :requirements=>"0.4004", :kind=>"configure", :platform=>"Cpan"},
      {:package_name=>"perl", :requirements=>"v5.28.1", :kind=>"runtime", :platform=>"Cpan"}
    ]
  end
end
