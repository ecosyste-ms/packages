...
class PuppetTest < ActiveSupport::TestCase
  ...
  test 'all_package_names' do
    ...
    stub_request(:get, "https://forge.puppet.com/v3/modules?limit=100&offset=100")
  ...
  test 'recently_updated_package_names' do
    stub_request(:get, "https://forge.puppet.com/v3/modules?limit=100&sort_by=latest_release")
  ...
  test 'versions_metadata' do
    stub_request(:get, "https://forge.puppet.com/v3/modules/puppet-fail2ban")
      .to_return({ status: 200, body: file_fixture('puppet/puppet-fail2ban') })
    stub_request(:get, "https://forge.puppet.com/v3/releases/puppet-fail2ban-4.1.0")
      .to_return({ status: 200, body: file_fixture('puppet/puppet-fail2ban-4.1.0') })
    stub_request(:get, "https://forge.puppet.com/v3/releases/puppet-fail2ban-4.0.0")
